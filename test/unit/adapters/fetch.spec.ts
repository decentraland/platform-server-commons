...
describe('Fetch', () => {
  ...
  it('should parse json correctly', async () => {
    ...
    let response = await fetcher.fetch('http://localhost/something');
  ...
  it('should throw error on error response', async () => {
    ...
    await expect(fetcher.fetch('http://localhost/something')).rejects.toThrow('HTTP Error Response: 404 Not found for URL http://localhost/something')
  })
})
